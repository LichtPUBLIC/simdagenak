...
class SettingTahun extends Database
{
    ...
    public function ACTION_add(){
        ...
        $sqlCek = "SELECT COUNT(*) FROM ref_tahun WHERE tahun = :tahun";
        $jml = $this->dbDataGetValue($sqlCek, ['tahun' => $tahun]);
        
        if ($jml > 0) {
            echo '{"success": false, "msg": "Data tahun ' . htmlspecialchars($tahun) . ' sudah ada di database!"}';
            return;
        }
        
        $sql = "insert into ref_tahun (tahun, aktif) VALUES 
                                          (:tahun, :aktif)";
    ...
    public function ACTION_update(){
        ...
        $tahun = $params['data']['tahun'];
        $id_tahun = $params['data']['id_tahun'];
        $sqlCek = "SELECT COUNT(*) FROM ref_tahun WHERE tahun = :tahun AND id_tahun != :id_tahun";
        $jml = $this->dbDataGetValue($sqlCek, ['tahun' => $tahun, 'id_tahun' => $id_tahun]);
        ...
        $sql = "update ref_tahun set tahun=:tahun, aktif=:aktif
